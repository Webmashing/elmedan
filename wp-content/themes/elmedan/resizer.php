...
function resize($imagePath,$opts=null){
	...
	# start configuration
	$cacheFolder = './wp-content/uploads/cache/'; # path to your cache folder, must be writeable by web server
    ...
    if(file_exists($newPath) == true):
        $create = false;
        $origFileTime = date("Y-m-d H:i:s",filemtime($imagePath));
        $newFileTime = date("Y-m-d H:i:s",filemtime($newPath));
